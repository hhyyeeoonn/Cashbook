        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">                   
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <div class="col-lg-8 mb-4" style = "margin:0 auto;"> <!-- col-lg-10 : 12까지만-->
							...
							<div class = "container center-block">
	                            <div class="card shadow mb-4">
	                        		<div class="card-header py-3">
	                           			<h6 class="m-0 font-weight-bold text-primary">Insert Comment</h6>
	                       			</div>
	                        		<div class="card-body">
										...
										<div>
											<form action="<%=request.getContextPath()%>/adminHelp/insertCommentAction.jsp?helpNo=<%=helpNo%>" method="post">
												...
												<table class="table table-borderless">
													...
													<tr>
														<td>
															<textarea cols="80" rows = "5" name="commentMemo"></textarea>
														</td>
													</tr>
												</table>

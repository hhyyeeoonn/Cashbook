                        ...
                        <div class="col-lg-11 mb-4" style = "margin:0 auto;"> <!-- col-lg-10 : 12까지만-->
                            ...
                            <div class="card shadow mb-4">
                        		...
                        		<div class="card-body">
									...
									<div>
										<a href="<%=request.getContextPath()%>/admin/insertNoticeForm.jsp">
											<button type ="button" class="btn btn-primary">새 공지 작성</button>
										</a>
									</div>
									<br>
									<div>
									...
									<div>
										<nav aria-label="Page navigation example">
								 			<ul class="pagination">
												...
												%>
													<li class="page-item">
														<a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=1" aria-label="Previous">처음</a>
													</li>
													<li class="page-item">
														<a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage-1%>">이전</a>
													</li>
												<%
													}
												%>
													<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage%>"><%=currentPage%></a></li>
												<%
													if(currentPage < noticeLastPage-1) {
												%>
													<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage+1%>"><%=currentPage+1%></a></li>
													<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage+2%>"><%=currentPage+2%></a></li>
												<%
													}
												%>
												<li class="page-item">
												<%
													if(currentPage < noticeLastPage-3) { 
												%>
														<a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=currentPage+3%>">다음</a>
												<%
													}
												%>
												</li>
												...
												%>
													<a class="page-link" href="<%=request.getContextPath()%>/admin/noticeList.jsp?currentPage=<%=noticeLastPage%>">마지막</a>
												<%
													}
												%>
												</li>

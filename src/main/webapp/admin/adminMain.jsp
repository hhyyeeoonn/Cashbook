											...
											<div>
												<span>
													<%
														...
														if(currentPage > 1) {
													%>
															<a href="<%=request.getContextPath()%>/cash/cashNoticeList.jsp?currentPage=1">처음</a>
															<a href="<%=request.getContextPath()%>/cash/cashNoticeList.jsp?currentPage=<%=currentPage-1%>">이전</a>
													<%
														}
													%>
												</span>
												...
												<span>
													...
													%>
															<a href="<%=request.getContextPath()%>/cash/cashNoticeList.jsp?currentPage=<%=currentPage+1%>">다음</a>
													<%
														}
													%>		
												</span>
												<span>
													<%
														if(currentPage < noticeLastPage) {
													%>
														<a href="<%=request.getContextPath()%>/cash/cashNoticeList.jsp?currentPage=<%=noticeLastPage%>">마지막</a>
													<%
														}
													%>
												</span>

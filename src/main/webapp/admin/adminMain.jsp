...
<%
	...
	ArrayList<Notice> list = noticeDao.selectNoticeListByPage(beginRow, rowPerPage); // 최근 공지
	int noticeLastPage = noticeDao.selectNoticeCount(rowPerPage); // -> lastPage 

	MemberDao memberDao = new MemberDao(); // 새로운 회원
          					...
          					<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
             					...
             					<a class="dropdown-item d-flex align-items-center" href="#">
                  					<div class="dropdown-list-image mr-3">
                      					<img class="rounded-circle" src="<%=request.getContextPath()%>/Resources/img/undraw_profile_1.svg" alt="...">
              					...
              					<a class="dropdown-item d-flex align-items-center" href="#">
                  					<div class="dropdown-list-image mr-3">
                      					<img class="rounded-circle" src="<%=request.getContextPath()%>/Resources/img/undraw_profile_2.svg"	alt="...">

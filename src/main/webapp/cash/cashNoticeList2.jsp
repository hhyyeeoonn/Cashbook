										...
										<div>
											<nav aria-label="Page navigation example">
									 			<ul class="pagination">
													...
													%>
														<li class="page-item">
															<a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jspcurrentPage=1" aria-label="Previous">처음</a>
														</li>
														<li class="page-item">
															<a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=currentPage-1%>">이전</a>
														</li>
													<%
														}
													%>
														<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=currentPage%>"><%=currentPage%></a></li>
													<%
														if(currentPage < noticeLastPage-1) {
													%>
														<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=currentPage+1%>"><%=currentPage+1%></a></li>
														<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=currentPage+2%>"><%=currentPage+2%></a></li>
													<%
														}
													%>
													<li class="page-item">
													...
													%>
															<a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=currentPage+3%>">다음</a>
													<%
														}
													%>
													</li>
													...
													%>
														<a class="page-link" href="<%=request.getContextPath()%>/cash/cashNoticeList2.jsp?currentPage=<%=noticeLastPage%>">마지막</a>
													<%
														}
													%>
													</li>
